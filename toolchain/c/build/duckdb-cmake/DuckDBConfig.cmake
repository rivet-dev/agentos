...
set(DuckDB_EXTENSIONS "core_functions")

include(CMakeFindDependencyMacro)
find_dependency(Threads)
if("icu" IN_LIST DuckDB_EXTENSIONS AND NOT )
    find_dependency(ICU COMPONENTS i18n uc data)
endif()

# Compute paths
get_filename_component(DuckDB_CMAKE_DIR "${CMAKE_CURRENT_LIST_FILE}" PATH)
set(DuckDB_INCLUDE_DIRS "/home/nathan/.herdr/workspaces/agent-os/reg-tests/toolchain/c/libs/duckdb/src/include")
