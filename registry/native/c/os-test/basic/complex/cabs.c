/* Test whether a basic cabs invocation works. */
	...
	if ( !(flags & MF_UNSPEC1) )
	{
		       ...
		       output == expected) )
		{
			if ( imprecise && isfinite(output) && isfinite(expected) )
				return;
			warnx("(%d.) cabs(%.4f + i*%.4f) = %.14a, not %.14a, diff %.14a, ratio %.16g",
...
int main(void)
{
	test(1, CMPLX(90.01, 13.37), 0x1.6bfd81ea6a64bp+6, 0x1.6bfd81ea6a64cp+6, 0x1.6bfd81ea6a64dp+6, 0);
	test(2, CMPLX(-12.34, 13.37), 0x1.231bd8cde3012p+4, 0x1.231bd8cde3013p+4, 0x1.231bd8cde3014p+4, 0);
	...
	test(7, CMPLX(90.01, -12.34), 0x1.6b6863f779f91p+6, 0x1.6b6863f779f92p+6, 0x1.6b6863f779f93p+6, 0);
	test(8, CMPLX(-12.34, -12.34), 0x1.1738ea57368adp+4, 0x1.1738ea57368aep+4, 0x1.1738ea57368afp+4, 0);
	...
	test(12, CMPLX(0.0, -12.34), 0x1.8ae147ae147adp+3, 0x1.8ae147ae147aep+3, 0x1.8ae147ae147afp+3, 0);
	...
	test(32, CMPLX(-12.34, 0.0), 0x1.8ae147ae147adp+3, 0x1.8ae147ae147aep+3, 0x1.8ae147ae147afp+3, 0);
