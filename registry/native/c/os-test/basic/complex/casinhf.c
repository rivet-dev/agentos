/* Test whether a basic casinhf invocation works. */
...
{
	float complex output = casinhf(input1);
	if ( !(flags & MF_UNSPEC1) )
	{
		       ...
		       real == expected_real) )
		{
			if ( imprecise && isfinite(real) && isfinite(expected_real) )
				return;
			warnx("(%d.) casinhf(%.4f + i*%.4f).real = %.6a, not %.6a, diff %.6a, ratio %.8g",
		       ...
		       imag == expected_imag) )
		{
			if ( imprecise && isfinite(imag) && isfinite(expected_imag) )
				return;
			warnx("(%d.) casinhf(%.4f + i*%.4f).imag = %.6a, not %.6a, diff %.6a, ratio %.8g",
...
int main(void)
{
	test(1, CMPLXF(90.01, 13.37), CMPLXF(0x1.4d0e7ap+2, 0x1.2dfb56p-3), CMPLXF(0x1.4d0e7cp+2, 0x1.2dfb58p-3), CMPLXF(0x1.4d0e7ep+2, 0x1.2dfb5ap-3), 0);
	test(2, CMPLXF(-12.34, 13.37), CMPLXF(-0x1.cc0e9ep+1, 0x1.a63d3ep-1), CMPLXF(-0x1.cc0e9cp+1, 0x1.a63d4p-1), CMPLXF(-0x1.cc0e9ap+1, 0x1.a63d42p-1), 0);
	...
	test(6, CMPLXF(0.0, 13.37), CMPLXF(0x1.a472fap+1, 0x1.921fb4p+0), CMPLXF(0x1.a472fcp+1, 0x1.921fb6p+0), CMPLXF(0x1.a472fep+1, 0x1.921fb8p+0), 0);
	test(7, CMPLXF(90.01, -12.34), CMPLXF(0x1.4cf43cp+2, -0x1.170426p-3), CMPLXF(0x1.4cf43ep+2, -0x1.170424p-3), CMPLXF(0x1.4cf44p+2, -0x1.170422p-3), 0);
	test(8, CMPLXF(-12.34, -12.34), CMPLXF(-0x1.c6ba8cp+1, -0x1.91b42p-1), CMPLXF(-0x1.c6ba8ap+1, -0x1.91b41ep-1), CMPLXF(-0x1.c6ba88p+1, -0x1.91b41cp-1), 0);
	...
	test(12, CMPLXF(0.0, -12.34), CMPLXF(0x1.9a280cp+1, -0x1.921fb8p+0), CMPLXF(0x1.9a280ep+1, -0x1.921fb6p+0), CMPLXF(0x1.9a281p+1, -0x1.921fb4p+0), 0);
	...
	test(23, CMPLXF(strtof("-inf", NULL), strtof("inf", NULL)), CMPLXF(strtof("-inf", NULL), 0x1.921fb4p-1), CMPLXF(strtof("-inf", NULL), 0x1.921fb6p-1), CMPLXF(strtof("-inf", NULL), 0x1.921fb8p-1), 0);
	...
	test(29, CMPLXF(strtof("-inf", NULL), strtof("-inf", NULL)), CMPLXF(strtof("-inf", NULL), -0x1.921fb8p-1), CMPLXF(strtof("-inf", NULL), -0x1.921fb6p-1), CMPLXF(strtof("-inf", NULL), -0x1.921fb4p-1), 0);
	...
	test(31, CMPLXF(90.01, 0.0), CMPLXF(0x1.4c5bbap+2, -0x1.0p-149), CMPLXF(0x1.4c5bbcp+2, 0x0.0p+0), CMPLXF(0x1.4c5bbep+2, 0x1.0p-149), 0);
	test(32, CMPLXF(-12.34, 0.0), CMPLXF(-0x1.9a93a8p+1, -0x1.0p-149), CMPLXF(-0x1.9a93a6p+1, 0x0.0p+0), CMPLXF(-0x1.9a93a4p+1, 0x1.0p-149), 0);
