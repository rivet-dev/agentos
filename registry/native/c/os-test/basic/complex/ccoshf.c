/* Test whether a basic ccoshf invocation works. */
...
{
	float complex output = ccoshf(input1);
	if ( !(flags & MF_UNSPEC1) )
	{
		       ...
		       real == expected_real) )
		{
			if ( imprecise && isfinite(real) && isfinite(expected_real) )
				return;
			warnx("(%d.) ccoshf(%.4f + i*%.4f).real = %.6a, not %.6a, diff %.6a, ratio %.8g",
		       ...
		       imag == expected_imag) )
		{
			if ( imprecise && isfinite(imag) && isfinite(expected_imag) )
				return;
			warnx("(%d.) ccoshf(%.4f + i*%.4f).imag = %.6a, not %.6a, diff %.6a, ratio %.8g",
...
int main(void)
{
	...
	test(2, CMPLXF(-12.34, 13.37), CMPLXF(0x1.35fcfap+16, -0x1.418098p+16), CMPLXF(0x1.35fcfcp+16, -0x1.418096p+16), CMPLXF(0x1.35fcfep+16, -0x1.418094p+16), 0);
	...
	test(6, CMPLXF(0.0, 13.37), CMPLXF(0x1.6360e4p-1, -0x1.0p-149), CMPLXF(0x1.6360e6p-1, 0x0.0p+0), CMPLXF(0x1.6360e8p-1, 0x1.0p-149), 0);
	...
	test(8, CMPLXF(-12.34, -12.34), CMPLXF(0x1.b3361cp+16, -0x1.90f2cp+14), CMPLXF(0x1.b3361ep+16, -0x1.90f2bep+14), CMPLXF(0x1.b3362p+16, -0x1.90f2bcp+14), 0);
	...
	test(12, CMPLXF(0.0, -12.34), CMPLXF(0x1.f2f002p-1, -0x1.0p-149), CMPLXF(0x1.f2f004p-1, 0x0.0p+0), CMPLXF(0x1.f2f006p-1, 0x1.0p-149), 0);
	...
	test(24, CMPLXF(0.0, strtof("inf", NULL)), CMPLXF(nanf(""), -0x1.0p-149), CMPLXF(nanf(""), 0x0.0p+0), CMPLXF(nanf(""), 0x1.0p-149), 0);
	...
	test(30, CMPLXF(0.0, strtof("-inf", NULL)), CMPLXF(nanf(""), -0x1.0p-149), CMPLXF(nanf(""), 0x0.0p+0), CMPLXF(nanf(""), 0x1.0p-149), 0);
	...
	test(32, CMPLXF(-12.34, 0.0), CMPLXF(0x1.be9afcp+16, -0x1.0p-149), CMPLXF(0x1.be9afep+16, -0x0.0p+0), CMPLXF(0x1.be9bp+16, 0x1.0p-149), 0);
