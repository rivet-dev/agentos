/* Test whether a basic csinhl invocation works. */
...
{
	long double complex output = csinhl(input1);
	if ( !(flags & MF_UNSPEC1) )
	{
		       ...
		       real == expected_real) )
		{
			if ( imprecise && isfinite(real) && isfinite(expected_real) )
				return;
			warnx("(%d.) csinhl(%.4Lf + i*%.4Lf).real = %.17La, not %.17La, diff %.17La, ratio %.20Lg",
		       ...
		       imag == expected_imag) )
		{
			if ( imprecise && isfinite(imag) && isfinite(expected_imag) )
				return;
			warnx("(%d.) csinhl(%.4Lf + i*%.4Lf).imag = %.17La, not %.17La, diff %.17La, ratio %.20Lg",
...
int main(void)
{
	...
	test(2, CMPLXL(-12.34, 13.37), CMPLXL(-0x9.afe7bb0fc59fbe2p+13L, 0xa.0c04a4e3218156dp+13L), CMPLXL(-0x9.afe7bb0fc59fbe1p+13L, 0xa.0c04a4e3218156ep+13L), CMPLXL(-0x9.afe7bb0fc59fbep+13L, 0xa.0c04a4e3218156fp+13L), 0);
	...
	test(6, CMPLXL(0.0, 13.37), CMPLXL(-0x0.000000000000001p-16385L, 0xb.84a0de29eb10817p-4L), CMPLXL(0x0.0p+0L, 0xb.84a0de29eb10818p-4L), CMPLXL(0x0.000000000000001p-16385L, 0xb.84a0de29eb10819p-4L), 0);
	...
	test(8, CMPLXL(-12.34, -12.34), CMPLXL(-0xd.99b0c36ebd8895bp+13L, 0xc.879655a638d024p+11L), CMPLXL(-0xd.99b0c36ebd8895ap+13L, 0xc.879655a638d0241p+11L), CMPLXL(-0xd.99b0c36ebd88959p+13L, 0xc.879655a638d0242p+11L), 0);
	...
	test(12, CMPLXL(0.0, -12.34), CMPLXL(-0x0.000000000000001p-16385L, 0xe.5d42e58f5a5c8abp-6L), CMPLXL(0x0.0p+0L, 0xe.5d42e58f5a5c8acp-6L), CMPLXL(0x0.000000000000001p-16385L, 0xe.5d42e58f5a5c8adp-6L), 0);
	...
	test(17, CMPLXL(strtold("-inf", NULL), nanl("")), CMPLXL(strtold("inf", NULL), nanl("")), CMPLXL(strtold("inf", NULL), nanl("")), CMPLXL(strtold("inf", NULL), nanl("")), 0 | MF_ANYSIGN1);
	...
	test(23, CMPLXL(strtold("-inf", NULL), strtold("inf", NULL)), CMPLXL(strtold("inf", NULL), nanl("")), CMPLXL(strtold("inf", NULL), nanl("")), CMPLXL(strtold("inf", NULL), nanl("")), 0 | MF_ANYSIGN1);
	...
	test(29, CMPLXL(strtold("-inf", NULL), strtold("-inf", NULL)), CMPLXL(strtold("inf", NULL), nanl("")), CMPLXL(strtold("inf", NULL), nanl("")), CMPLXL(strtold("inf", NULL), nanl("")), 0 | MF_ANYSIGN1);
	...
	test(32, CMPLXL(-12.34, 0.0), CMPLXL(-0xd.f4d7cee6d57be0ep+13L, -0x0.000000000000001p-16385L), CMPLXL(-0xd.f4d7cee6d57be0dp+13L, 0x0.0p+0L), CMPLXL(-0xd.f4d7cee6d57be0cp+13L, 0x0.000000000000001p-16385L), 0);
