/* Test whether a basic llrintf invocation works. */
...
void test(int variant, float input1, int errnum, int fperr, long long expected, int flags)
{
	...
	{
		if ( output != expected )
			errx(1, "(%d.) llrintf(%.4f) = %lld, not %lld",
