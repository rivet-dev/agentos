/* Test whether a basic ilogbl invocation works. */
...
int main(void)
{
	...
	test(3, nanl(""), EDOM, FE_INVALID, FP_ILOGBNAN, 0);
	test(4, strtold("inf", NULL), EDOM, FE_INVALID, INT_MAX, 0);
	test(5, strtold("-inf", NULL), EDOM, FE_INVALID, INT_MAX, 0);
