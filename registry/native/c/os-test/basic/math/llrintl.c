/* Test whether a basic llrintl invocation works. */
...
void test(int variant, long double input1, int errnum, int fperr, long long expected, int flags)
{
	...
	{
		if ( output != expected )
			errx(1, "(%d.) llrintl(%.4Lf) = %lld, not %lld",
