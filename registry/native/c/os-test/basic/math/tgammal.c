/* Test whether a basic tgammal invocation works. */
	...
	if ( !(flags & MF_UNSPEC1) )
	{
		       ...
		       output == expected) )
		{
			if ( imprecise && isfinite(output) && isfinite(expected) )
				return;
			warnx("(%d.) tgammal(%.4Lf) = %.17La, not %.17La, diff %.17La, ratio %.20Lg",
...
int main(void)
{
	test(1, 90.01, 0, 0, 0xb.e0c55422b07b981p+449L, 0xb.e0c55422b07b982p+449L, 0xb.e0c55422b07b983p+449L, 0);
	test(2, -12.34, 0, 0, -0xd.8e64b2ccdca5e7p-32L, -0xd.8e64b2ccdca5e6fp-32L, -0xd.8e64b2ccdca5e6ep-32L, 0);
