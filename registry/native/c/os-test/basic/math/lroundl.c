/* Test whether a basic lroundl invocation works. */
...
void test(int variant, long double input1, int errnum, int fperr, long expected, int flags)
{
	...
	{
		if ( output != expected )
			errx(1, "(%d.) lroundl(%.4Lf) = %ld, not %ld",
...
int main(void)
{
	test(1, 90.01, 0, 0, 90L, 0);
	test(2, -12.34, 0, 0, -12L, 0);
