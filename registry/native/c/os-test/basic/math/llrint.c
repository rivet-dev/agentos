/* Test whether a basic llrint invocation works. */
...
void test(int variant, double input1, int errnum, int fperr, long long expected, int flags)
{
	...
	{
		if ( output != expected )
			errx(1, "(%d.) llrint(%.4f) = %lld, not %lld",
