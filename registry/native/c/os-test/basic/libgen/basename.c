/*[XSI]*/
/* Test whether a basic basename invocation works. */
...
int main(void)
{
	...
	char copy1[] = "foo";
	char expected1[] = "foo";
	char* output1 = basename(input1);
	if ( strcmp(output1, expected1) != 0 )
		errx(1, "basename(\"%s\") was \"%s\" not \"%s\"",
		     copy1, output1, expected1);

	char input2[] = "foo/";
	char copy2[] = "foo/";
	char expected2[] = "foo";
	char* output2 = basename(input2);
	...
	char copy5[] = "//foo//bar//";
	char expected5[] = "bar";
	char* output5 = basename(input5);
	if ( strcmp(output5, expected5) != 0 )
		errx(1, "basename(\"%s\") was \"%s\" not \"%s\"",
		     copy5, output5, expected5);

	char input6[] = "/foo/bar/.";
	char copy6[] = "/foo/bar/.";
	char expected6[] = ".";
	char* output6 = basename(input6);
	...
	char expected10a[] = "/";
	char expected10b[] = "//";
	char* output10 = basename(input10);
	...
	char copy11[] = "///";
	char expected11[] = "/";
	char* output11 = basename(input11);
	...
	char copy12[] = "";
	char expected12[] = ".";
	char* output12 = basename(input12);
	...
	char* input13 = NULL;
	char expected13[] = ".";
	char* output13 = basename(input13);
	if ( strcmp(output13, expected13) != 0 )
		errx(1, "basename(NULL) was \"%s\" not \"%s\"",
		     output13, expected13);
