/*[MSG]*/
/* Test whether a basic mq_setattr invocation works. */
...
int main(void)
{
	...
	mqd_t mq = create_mq(&mq_path, &init);
	struct mq_attr attr;
	if ( mq_getattr(mq, &attr) < 0 )
		err(1, "first mq_getattr");
	if ( attr.mq_flags & O_CLOEXEC )
		errx(1, "attr.mq_flags & O_CLOEXEC");
	if ( attr.mq_flags & O_NONBLOCK )
		errx(1, "attr.mq_flags & O_NONBLOCK");
	if ( attr.mq_flags & O_NONBLOCK != 0 )
		errx(1, "attr.mq_flags & O_NONBLOCK != 0");
	if ( attr.mq_maxmsg != 2 )
		errx(1, "attr.mq_maxmsg != 2");
	if ( attr.mq_msgsize != 3 )
		errx(1, "attr.mq_msgsize != 3");
	if ( attr.mq_curmsgs != 0 )
		errx(1, "attr.mq_curmsgs != 0");
	...
	if ( mq_setattr(mq, &new_attr, &old_attr) < 0 )
		err(1, "mq_setattr");
	if ( old_attr.mq_flags & O_NONBLOCK != 0 )
		errx(1, "old_attr.mq_flags & O_NONBLOCK != 0");
	if ( old_attr.mq_maxmsg != 2 )
		errx(1, "old_attr.mq_maxmsg != 2");
	if ( old_attr.mq_msgsize != 3 )
		errx(1, "old_attr.mq_msgsize != 3");
	if ( old_attr.mq_curmsgs != 0 )
		errx(1, "old_attr.mq_curmsgs != 0");
	struct mq_attr final_attr;
	if ( mq_getattr(mq, &final_attr) < 0 )
		err(1, "second mq_getattr");
	if ( final_attr.mq_flags & O_NONBLOCK != O_NONBLOCK )
		errx(1, "final_attr.mq_flags & O_NONBLOCK != O_NONBLOCK");
	if ( final_attr.mq_maxmsg != 2 )
		errx(1, "final_attr.mq_maxmsg != 2");
	if ( final_attr.mq_msgsize != 3 )
		errx(1, "final_attr.mq_msgsize != 3");
	if ( final_attr.mq_curmsgs != 0 )
		errx(1, "final_attr.mq_curmsgs != 0");
	return 0;
}
