...
| **agentOS Core** | Use `@rivet-dev/agentos-core` directly without the Rivet platform. Embed the runtime in any Node.js backend. | Custom integrations and existing infrastructure |
