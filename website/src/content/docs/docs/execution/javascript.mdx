...
<CodeSnippet file="examples/js-quickstart/src/index.ts" region="vanilla-javascript" />
...
<CodeSnippet file="examples/js-sdk-overview/src/lifecycle.ts" />
...
<CodeSnippet file="examples/bindings/guest.mjs" />
