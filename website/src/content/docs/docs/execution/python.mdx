...
<CodeSnippet file="examples/python-quickstart/src/index.ts" region="python" />
...
<CodeSnippet file="examples/python-sdk-overview/src/lifecycle.ts" />
...
<CodeSnippet file="examples/python-sdk-overview/src/workflows.ts" />
...
<CodeSnippet file="examples/bindings/guest.py" lang="text" />
