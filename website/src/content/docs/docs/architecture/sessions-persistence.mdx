...
description: "How Agent OS, ACP, RivetKit actors, and durable session persistence fit together."
---

Agent OS runs coding agents inside VMs and talks to them through the Agent
