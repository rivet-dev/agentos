...
const orchestrationFeatures = [
	...
	{ icon: Activity, title: 'Observability', description: 'Watch the transcript, filesystem, and processes of a live VM. Every event also streams to your code.', docsHref: '/docs/inspector' },
];
