...
Before reaching for logs, open the [inspector](/docs/inspector): it shows the live transcript, pending permission requests (the most common reason an agent looks stuck), the process tree, and a shell into the VM.
