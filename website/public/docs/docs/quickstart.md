...
4. **Run it**
   ...
   With the server running, open http://localhost:6420/ui to watch the VM in the [inspector](/docs/inspector): the live transcript, a terminal, the filesystem, and its processes.
