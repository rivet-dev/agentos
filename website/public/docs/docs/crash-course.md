...
*See [Full Example](https://github.com/rivet-dev/agentos/tree/main/examples/bindings) or [Documentation](/docs/extensions/custom-bindings)*

### Agent-to-Agent

Let one agent call another through a [custom binding](/docs/extensions/custom-bindings). The coder gets a `review` binding it invokes itself, which bridges into the reviewer's isolated VM.
...
[Documentation](/docs/extensions/sandboxes)