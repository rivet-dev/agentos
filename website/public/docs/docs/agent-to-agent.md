...
Agents communicate through [custom bindings](/docs/extensions/custom-bindings). You define a bindings group that lets one agent send work to another, and the agent calls it like any other CLI command.
