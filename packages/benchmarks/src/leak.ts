...
function fileLine(signal: string): string {
	if (signal.includes("Process")) return "crates/vm-kernel/src/process_table.rs:842";
	if (signal === "sidecarRss") return "crates/vm-kernel/src/resource_accounting.rs:36";
	return "crates/vm-kernel/src/kernel.rs:581";
}
