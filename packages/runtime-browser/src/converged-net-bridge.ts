...
// payload (`guest_kernel_call` -> `agentos_native_sidecar_core::guest_net`), which
...
import type { LiveRequestPayload, LiveResponsePayload } from "@rivet-dev/agentos-runtime-core";
