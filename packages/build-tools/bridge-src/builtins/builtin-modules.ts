...
import { builtinConsoleModule, installBuiltinUtilFormatWithOptions } from "./console.js";
import { builtinCryptoModule } from "./crypto.js";
import { builtinDiagnosticsChannelModule, builtinStreamConsumersModule, builtinStreamPromisesModule, builtinTtyModule, builtinWorkerThreadsModule, createAccessDeniedBuiltinError } from "./misc-stubs.js";
import { builtinPerfHooksModule } from "./perf.js";
import { fileURLToPath2, pathToFileURL2, process_default } from "./process.js";
import { builtinAsyncHooksModule, builtinTimersPromisesModule } from "./timers.js";
...
function loadBuiltinModule(request) {
  ...
  switch (normalized) {
    ...
    case "wasi":
      if (globalThis.__agentOSBuiltinWasiModule) {
        return globalThis.__agentOSBuiltinWasiModule;
      }
      throw createAccessDeniedBuiltinError(request);
    case "zlib":
...
export { builtinModules, builtinTimersModule, unwrapStdlibModule, cloneStdlibModule, defineMissingModuleProperty, trimNonRootTrailingSlash, builtinBufferStdlibModule, builtinConstantsStdlibModule, builtinEventsStdlibModule, builtinEventsConstructor, builtinEventsStdlibModuleInitialized, ensureBuiltinEventsStdlibModule, builtinPathStdlibModule, builtinPunycodeStdlibModule, builtinQuerystringStdlibModule, builtinStreamStdlibModule, defineReadableAsyncIterator, builtinStringDecoderStdlibModule, builtinUrlStdlibModule, builtinUrlStdlibModuleInitialized, ensureBuiltinUrlStdlibModule, normalizeBuiltinRequest, __jsRuntimeBuiltinAllowlist, rejectRestrictedBuiltinRequest, loadBuiltinModule };
