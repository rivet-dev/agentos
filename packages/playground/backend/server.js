...
function isWithinPlayground(candidatePath) {
    return (candidatePath === playgroundDir ||
...
function getRedirectLocation(urlPath) {
...
function writeHeaders(response, status, extras = {}) {
...
export function startBrowserPlaygroundServer(port = DEFAULT_PORT) {
