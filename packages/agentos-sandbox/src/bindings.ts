/**
 * Sandbox bindings exposing process management and command execution to an
 * agent running inside an AgentOS VM.
 */

import type { Binding, Bindings } from "@rivet-dev/agentos-core";
...
/** Binding helper kept local so this package only needs the public types. */
...
/**
 * Create bindings that expose sandbox process management operations.
 */
