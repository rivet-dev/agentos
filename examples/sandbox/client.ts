...
const result = await vm.process.exec("node /home/agentos/sandbox/app/index.ts");
...
const install = await vm.process.exec("npm install --prefix /home/agentos/sandbox/app");
