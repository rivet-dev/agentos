...
use agentos_vm_host_interface::{
    ...
    FileKind, FilesystemAccess, FilesystemPermissionRequest, FilesystemSnapshot,
    FlushFilesystemStateRequest, GuestKernelCall, GuestRuntime, LifecycleEventRecord,
    ...
    StartExecutionRequest, StructuredEventRecord, SymlinkRequest, TruncateRequest, VmHost,
    VmHostTypes, WriteExecutionStdinRequest, WriteFileRequest,
};
    ...
    <B as VmHostTypes>::Error: Debug,
{
    ...
    bridge
        ...
        .expect("close stdin");
    bridge
        .kill_execution(agentos_vm_host_interface::KillExecutionRequest {
            vm_id: String::from("vm-1"),
