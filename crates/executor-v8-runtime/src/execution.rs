...
/// (executor-v8-runtime), but the module reader/resolver lives in the higher `execution`
...
fn build_cjs_esm_shim(
    ...
    // than intended (see crates/executor-v8-runtime/CLAUDE.md). Static still back-fills names that a
