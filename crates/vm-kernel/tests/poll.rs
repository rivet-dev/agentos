...
use agentos_vm_kernel::pipe_manager::{MAX_PIPE_BUFFER_BYTES, PIPE_BUF_BYTES};
...
use agentos_vm_kernel::socket_table::{InetSocketAddress, SocketShutdown, SocketSpec};
...
fn poll_targets_suppress_stream_pollout_when_socket_buffer_limit_is_full() {
    ...
    assert_eq!(
        ...
        agentos_vm_kernel::poll::PollEvents::empty()
    );
