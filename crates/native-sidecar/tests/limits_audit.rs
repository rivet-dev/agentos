...
fn match_rule_unit_assertions() {
    // Qualifying names.
    assert!(name_qualifies("MAX_HOST_FUNCTION_SCHEMA_BYTES"));
    ...
    assert_eq!(
        rust_const_name("pub(crate) const MAX_HOST_FUNCTION_TIMEOUT_MS: u64 = 300_000;"),
        Some("MAX_HOST_FUNCTION_TIMEOUT_MS")
    );
    assert_eq!(
