...
impl AbiManifest {
    ...
    pub fn render_rust_registry(&self) -> Result<String, String> {
        ...
        writeln!(
            output,
            "// Source: crates/executor-wasm-abi/assets/agentos-wasm-abi.json (schema {}).\n",
            self.schema_version
        )
        .unwrap();
...
mod tests {
    ...
    const CHECKED_MANIFEST: &str =
        include_str!("../../executor-wasm-abi/assets/agentos-wasm-abi.json");
