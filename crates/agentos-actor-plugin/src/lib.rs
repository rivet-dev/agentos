...
//! **unmodified** `agent-os-client` to spawn + drive the sidecar, calling back
...
/// drive the sidecar via `agent-os-client`) slots into `actor_loop` next.
#[no_mangle]
