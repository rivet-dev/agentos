...
pub struct DriverProtocolConfig {
...
impl Default for DriverProtocolConfig {
    fn default() -> Self {
        Self {
...
pub struct DriverConfig {
    ...
    /// Process-wide bound for active guest executors.
    ...
    pub protocol: DriverProtocolConfig,
}
...
impl Default for DriverConfig {
    fn default() -> Self {
        ...
        Self {
            ...
            protocol: DriverProtocolConfig::default(),
        }
    }
}
...
impl DriverConfig {
    pub fn validate(&self) -> Result<(), DriverBuildError> {
        ...
        if self.max_active_vm_executors == 0 {
...
mod tests {
    ...
    fn validates_request_and_output_protocol_capacities() {
        assert_eq!(
            DriverProtocolConfig::default().shutdown_grace_ms,
    ...
    fn validates_terminal_reservations_and_logical_control_capacity() {
        let mut terminal_frames = DriverConfig::default();
        ...
        let mut terminal_bytes = DriverConfig::default();
        ...
        let mut control_frames = DriverConfig::default();
        ...
        let mut control_bytes = DriverConfig::default();
