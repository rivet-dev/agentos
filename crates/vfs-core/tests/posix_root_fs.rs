...
use agentos_vfs_core::posix::{MemoryFileSystem, VirtualFileSystem, S_IFDIR, S_IFLNK, S_IFREG};
use agentos_vfs_core::posix::{OverlayFileSystem, OverlayMode};
...
fn assert_error_code<T: std::fmt::Debug>(
    result: Result<T, agentos_vfs_core::posix::VfsError>,
    expected: &str,
) {
