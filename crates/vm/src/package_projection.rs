...
use agentos_vfs_core::package_format::{generated::v2, read_manifest_chunk_from_file};
...
pub const MAX_AGENTOS_PACKAGE_MOUNTS: usize =
    crate::core::limits::DEFAULT_AGENTOS_PACKAGE_MAX_MOUNTS;
...
fn read_aospkg_manifest_chunk(path: &Path) -> Result<v2::PackageManifest, VmError> {
