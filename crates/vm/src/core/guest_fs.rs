...
use agentos_vm_kernel::kernel::KernelVm;
use agentos_vm_kernel::vfs::{VirtualFileSystem, VirtualStat};
use base64::Engine;
...
fn kernel_error(error: agentos_vm_kernel::kernel::KernelError) -> SidecarCoreError {
