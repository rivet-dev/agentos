...
//! [`crate::core::guest_net`] does for the `net.*`/`dns.*` family. It is delegated to
...
use agentos_vm_kernel::kernel::{KernelError, KernelVm};
use agentos_vm_kernel::pty::{PartialTermios, PartialTermiosControlChars};
...
/// the sidecar (mirrors the `net.poll` 50 ms ceiling in [`crate::core::guest_net`]).
...
mod tests {
    use super::*;
    use crate::core::guest_net::handle_guest_kernel_call;
