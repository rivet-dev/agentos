...
use agentos_vm_kernel::system::SystemIdentity;
use agentos_vm_kernel::user::UserManager;

use crate::core::{virtual_os_cpu_count, virtual_os_freemem_bytes, virtual_os_totalmem_bytes};
...
mod tests {
    use super::*;
    use agentos_vm_kernel::resource_accounting::ResourceLimits;
    use agentos_vm_kernel::user::{UserConfig, UserManager};
