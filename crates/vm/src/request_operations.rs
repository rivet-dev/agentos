...
use agentos_driver_tokio::DriverProtocolConfig;
...
pub struct RequestOperationLimits {
    pub(crate) max_requests: usize,
    pub(crate) max_request_bytes: usize,
}

impl From<&DriverProtocolConfig> for RequestOperationLimits {
    fn from(config: &DriverProtocolConfig) -> Self {
        Self {
...
pub struct RequestOperationKey {
    pub connection_id: String,
    pub request_id: RequestId,
}

impl RequestOperationKey {
    pub fn new(connection_id: impl Into<String>, request_id: RequestId) -> Self {
        Self {
...
#[derive(Clone, Debug, PartialEq, Eq)]
pub struct RequestOperationMetadata {
    pub ownership: OwnershipScope,
    pub operation: String,
    pub vm_concurrency: VmConcurrencyClass,
}
...
impl OperationCancellation {
    ...
    pub fn signal(&self, reason: OperationCancellationReason) -> bool {
        if self
            .inner
            .reason
...
#[derive(Clone, Debug)]
pub struct ResponsePublicationGuard {
    state: Arc<AtomicU8>,
}
...
#[derive(Clone, Debug, PartialEq, Eq)]
pub struct RequestOperationSnapshot {
    pub key: RequestOperationKey,
    pub metadata: RequestOperationMetadata,
    pub request_bytes: usize,
    pub cancellation_reason: Option<OperationCancellationReason>,
    pub(crate) terminal_claimed: bool,
}

#[derive(Clone, Debug, PartialEq, Eq)]
pub struct OperationTableSnapshot {
    pub in_flight_requests: usize,
    pub in_flight_request_bytes: usize,
    pub closed: Option<OperationCancellationReason>,
    pub(crate) closed_connections: BTreeSet<String>,
    pub operations: Vec<RequestOperationSnapshot>,
}

#[derive(Clone, Debug, PartialEq, Eq)]
pub struct ForcedRequestOutcome {
    pub key: RequestOperationKey,
    pub ownership: OwnershipScope,
}
...
impl OperationTable {
    ...
    pub fn new(limits: RequestOperationLimits) -> Self {
    ...
    pub fn from_protocol_config(config: &DriverProtocolConfig) -> Self {
    ...
    pub fn progress_requests(&self) -> ProgressOperationView {
    ...
    pub fn close(&self, reason: OperationCancellationReason) -> usize {
        let mut state = self.lock_state();
    ...
    pub fn reopen_scope(&self, scope: &OwnershipScope) {
        let mut state = self.lock_state();
    ...
    pub fn snapshot(&self) -> OperationTableSnapshot {
        let state = self.lock_state();
...
#[derive(Clone, Debug)]
pub struct ScopeOperationDrain {
...
impl RequestOperation {
    pub fn key(&self) -> &RequestOperationKey {
        &self.key
    }

    pub fn metadata(&self) -> &RequestOperationMetadata {
        &self.metadata
    }
    ...
    pub fn mark_terminal_retained(&self) -> bool {
...
#[derive(Clone, Debug, PartialEq, Eq)]
pub struct ProgressRequestLimits {
    pub(crate) max_requests: usize,
    pub(crate) max_request_bytes: usize,
}

impl From<&DriverProtocolConfig> for ProgressRequestLimits {
    fn from(config: &DriverProtocolConfig) -> Self {
        Self {
...
#[derive(Clone, Debug, PartialEq, Eq)]
pub struct ProgressRequestSnapshot {
    pub key: RequestOperationKey,
    pub ownership: OwnershipScope,
    pub request_bytes: usize,
    pub cancellation_reason: Option<OperationCancellationReason>,
...
#[derive(Clone, Debug, PartialEq, Eq)]
pub struct ProgressOperationSnapshot {
    pub in_flight_requests: usize,
    pub in_flight_request_bytes: usize,
    pub closed: Option<OperationCancellationReason>,
    pub(crate) closed_connections: BTreeSet<String>,
    pub requests: Vec<ProgressRequestSnapshot>,
}
...
#[derive(Clone, Debug)]
pub struct ProgressOperationView {
    inner: Arc<OperationTableInner>,
}

impl ProgressOperationView {
    #[cfg(any(test, feature = "test-support"))]
    pub fn new(limits: ProgressRequestLimits) -> Self {
    ...
    pub fn signal_all(&self, reason: OperationCancellationReason) -> usize {
        let state = self.lock_state();
        state
            .operations
            .values()
    ...
    pub fn snapshot(&self) -> ProgressOperationSnapshot {
        let state = self.lock_state();
...
impl ProgressRequest {
    ...
    pub fn mark_acknowledgement_retained(&self) -> bool {
        self.publication.mark_retained()
    }
...
#[derive(Clone, Debug, PartialEq, Eq)]
pub enum ProgressRequestAdmissionError {
    CountLimit {
        current: usize,
        requested: usize,
        limit: usize,
...
mod tests {
    ...
    fn progress_admission_uses_reserved_lane_limits_not_ordinary_limits() {
        let protocol = DriverProtocolConfig {
