...
//! ## Run
//! ```text
//! cargo test -p agentos-vm --release --test projection_bench -- --ignored --nocapture
...
/// `agentos_vfs_core::package_format::pack` (agentos-package.json is consumed at pack time
