...
const found = execSync(
	[
		...
		"-type d",
		"\\(",
		'-name node_modules -o -name dist -o -name .astro -o -name .cache -o -name .turbo -o -name .codex-build -o -name .output -o -name .eve -o -name vendor -o -name target -o -name archive -o -name .git -o -name .jj -o -name .claude',
		'-o -path "./packages/core/tests/integration/projects"',
		'-o -path "./crates/executor-v8-runtime/assets/undici-shims"',
		"\\)",
		"\\)",
